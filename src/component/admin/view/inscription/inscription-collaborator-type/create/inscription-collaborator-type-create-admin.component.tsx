...
const InscriptionCollaboratorTypeAdminCreate = () => {

    const [showSavedModal, setShowSavedModal] = useState(false);
    const [showErrorModal, setShowErrorModal] = useState(false);
    const [isInscriptionCollaboratorTypeCollapsed, setIsInscriptionCollaboratorTypeCollapsed] = useState(true);
    ...
    const { control, handleSubmit, reset } = useForm<InscriptionCollaboratorTypeDto>({
        defaultValues: {
        code: '' ,
        name: '' ,
        },
    ...
    const handleSave = async (item: InscriptionCollaboratorTypeDto) => {
        Keyboard.dismiss();
        try {
            ...
            console.error('Error saving inscriptionCollaboratorType:', error);
...
return(
    <SafeAreaView style={styles.safeAreaViewCreate} >
        <ScrollView style={styles.scrolllViewCreate} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" >
            <Text style={styles.textHeaderCreate} >Inscription Collaborator Type</Text>
...
export default InscriptionCollaboratorTypeAdminCreate;

...
const InscriptionCollaboratorStateAdminCreate = () => {

    const [showSavedModal, setShowSavedModal] = useState(false);
    const [showErrorModal, setShowErrorModal] = useState(false);
    const [isInscriptionCollaboratorStateCollapsed, setIsInscriptionCollaboratorStateCollapsed] = useState(true);
    ...
    const { control, handleSubmit, reset } = useForm<InscriptionCollaboratorStateDto>({
        defaultValues: {
        code: '' ,
        name: '' ,
        },
    ...
    const handleSave = async (item: InscriptionCollaboratorStateDto) => {
        Keyboard.dismiss();
        try {
            ...
            console.error('Error saving inscriptionCollaboratorState:', error);
...
return(
    <SafeAreaView style={styles.safeAreaViewCreate} >
        <ScrollView style={styles.scrolllViewCreate} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" >
            <Text style={styles.textHeaderCreate} > Inscription Collaborator State</Text>
...
export default InscriptionCollaboratorStateAdminCreate;

...
const DomainTemplateAdminCreate = () => {

    const [showSavedModal, setShowSavedModal] = useState(false);
    const [showErrorModal, setShowErrorModal] = useState(false);
    const [isDomainTemplateCollapsed, setIsDomainTemplateCollapsed] = useState(true);
    ...
    const { control, handleSubmit, reset } = useForm<DomainTemplateDto>({
        defaultValues: {
        code: '' ,
        name: '' ,
        },
    ...
    const handleSave = async (item: DomainTemplateDto) => {
        Keyboard.dismiss();
        try {
            ...
            console.error('Error saving domainTemplate:', error);
...
return(
    <SafeAreaView style={styles.safeAreaViewCreate} >
        <ScrollView style={styles.scrolllViewCreate} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" >
            <Text style={styles.textHeaderCreate} > Domain Template</Text>
...
export default DomainTemplateAdminCreate;

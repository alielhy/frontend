...
const CategoryProjectTemplateAdminCreate = () => {

    const [showSavedModal, setShowSavedModal] = useState(false);
    const [showErrorModal, setShowErrorModal] = useState(false);
    const [isCategoryProjectTemplateCollapsed, setIsCategoryProjectTemplateCollapsed] = useState(true);
    ...
    const { control, handleSubmit, reset } = useForm<CategoryProjectTemplateDto>({
        defaultValues: {
        code: '' ,
        name: '' ,
        },
    ...
    const handleSave = async (item: CategoryProjectTemplateDto) => {
        Keyboard.dismiss();
        try {
            ...
            console.error('Error saving categoryProjectTemplate:', error);
...
return(
    <SafeAreaView style={styles.safeAreaViewCreate} >
        <ScrollView style={styles.scrolllViewCreate} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" >
            <Text style={styles.textHeaderCreate} >Category Project Template</Text>
...
export default CategoryProjectTemplateAdminCreate;

...
const MemberAdminCard = ({ description ,collaboratorName ,credentialsNonExpired ,enabled ,accountNonExpired ,accountNonLocked ,passwordChanged ,username ,password , onPressDelete, onUpdate, onDetails }) =>{
...
export default MemberAdminCard;

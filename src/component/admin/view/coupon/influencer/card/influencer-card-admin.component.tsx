...
const InfluencerAdminCard = ({ nickName ,rib ,credentialsNonExpired ,enabled ,accountNonExpired ,accountNonLocked ,passwordChanged ,username ,password , onPressDelete, onUpdate, onDetails }) =>{
            ...
            <ScrollView horizontal>
                <View style={globalStyle.contentContainer}>
                    <View style={globalStyle.infos}>
                        ...
                        <Text style={globalStyle.value}>{truncateText(nickName)}</Text>
                    </View>
                    <View style={globalStyle.infos}>
...
export default InfluencerAdminCard;

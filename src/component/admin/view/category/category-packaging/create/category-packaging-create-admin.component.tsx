...
const CategoryPackagingAdminCreate = () => {

    const [showSavedModal, setShowSavedModal] = useState(false);
    const [showErrorModal, setShowErrorModal] = useState(false);
    const [isCategoryPackagingCollapsed, setIsCategoryPackagingCollapsed] = useState(true);
    ...
    const { control, handleSubmit, reset } = useForm<CategoryPackagingDto>({
        defaultValues: {
        code: '' ,
        name: '' ,
        },
    ...
    const handleSave = async (item: CategoryPackagingDto) => {
        Keyboard.dismiss();
        try {
            ...
            console.error('Error saving categoryPackaging:', error);
...
return(
    <SafeAreaView style={styles.safeAreaViewCreate} >
        <ScrollView style={styles.scrolllViewCreate} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" >
            <Text style={styles.textHeaderCreate} >Category Packaging</Text>
...
export default CategoryPackagingAdminCreate;
